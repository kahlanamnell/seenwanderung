...
$GLOBALS['TCA']['tx_seenwanderung_domain_model_waypoint'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_seenwanderung_domain_model_waypoint']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_seenwanderung_domain_model_waypoint.pid=###CURRENT_PID### AND tx_seenwanderung_domain_model_waypoint.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:seenwanderung/Resources/Private/Language/locallang_db.xlf:tx_seenwanderung_domain_model_waypoint.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
