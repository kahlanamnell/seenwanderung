	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_seenwanderung_domain_model_vehiclestation.pid=###CURRENT_PID### AND tx_seenwanderung_domain_model_vehiclestation.sys_language_uid IN (-1,0)',
			),
		),
		...
		'waypoint' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:seenwanderung/Resources/Private/Language/locallang_db.xlf:tx_seenwanderung_domain_model_vehiclestation.waypoint',
			'config' => array(
				'type' => 'select',
